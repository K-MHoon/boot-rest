...
import com.community.rest.DataRestApplication;
...
class BoardEventTest {
    ...
    private Board createBoard() {
        Board board = Board.builder().title("저장할 이벤트 테스트").build();
        return testRestTemplate.postForObject("http://127.0.0.1:8082/api/boards", board, Board.class);
    }

    private Board updateBoard(Board createdBoard) {
        String updateUri = "http://127.0.0.1:8082/api/boards/1";
